  ...
  return (
    <SiteLayout>
      ...
      <section className="relative">
        <img src={hero} alt="Summer Bloom Collection" width={1920} height={1080} className="w-full h-[60vh] sm:h-[78vh] object-cover" />
        <div className="absolute inset-0 flex items-center">
          <div className="mx-auto max-w-[1400px] w-full px-5 sm:px-10">
            <div className="max-w-md text-foreground">
              <p className="tracking-luxury text-[10px] sm:text-xs mb-2 sm:mb-3">The Summer Edit</p>
              <h1 className="font-display text-4xl sm:text-6xl md:text-7xl leading-[0.95] italic">Summer<br />Bloom</h1>
              <p className="mt-3 sm:mt-4 font-display text-xl sm:text-2xl">Up to <span className="italic">50% Off</span></p>
              <Button asChild className="mt-5 sm:mt-6 rounded-none h-11 sm:h-12 px-6 sm:px-8 tracking-luxury text-xs bg-[var(--beige-900)] hover:bg-[var(--beige-900)]/90 text-[var(--beige-50)]">
      ...
      <section className="mx-auto max-w-[1400px] px-4 sm:px-6 py-12 sm:py-20">
        <div className="flex items-end justify-between mb-6 sm:mb-10 gap-4">
          <div>
            ...
            <h2 className="font-display text-2xl sm:text-4xl">Featured Pieces</h2>
          </div>
          <Link to="/shop" className="text-xs tracking-luxury border-b border-foreground pb-1 shrink-0">View All</Link>
        </div>
      ...
      {/* Collections grid */}
      <section className="mx-auto max-w-[1400px] px-4 sm:px-6 py-8 sm:py-10">
        <h2 className="font-display text-2xl sm:text-4xl text-center mb-6 sm:mb-10">Shop by Silhouette</h2>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          {collections.map((c) => (
            <Link to="/shop" key={c.name} className="group block relative bg-[var(--beige-100)] overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-end p-5 sm:p-8 bg-gradient-to-t from-[var(--beige-900)]/40 to-transparent">
                <div>
                  <p className="text-[10px] tracking-luxury text-[var(--beige-50)]/80">Explore</p>
                  <h3 className="font-display text-2xl sm:text-3xl text-[var(--beige-50)]">{c.name}</h3>
                </div>
              </div>
            </Link>
          ))}
      ...
      {/* Editorial */}
      <section className="relative my-12 sm:my-24">
        <img src={veil} alt="Bridal Couture" loading="lazy" className="w-full h-[60vh] sm:h-[80vh] object-cover" />
        <div className="absolute inset-0 flex items-center justify-center text-center px-4">
          <div className="bg-background/85 px-6 sm:px-12 py-6 sm:py-10 max-w-xl">
            <p className="tracking-luxury text-xs text-muted-foreground mb-2 sm:mb-3">Bridal Couture</p>
            <h2 className="font-display text-3xl sm:text-5xl italic">An Heirloom in the Making</h2>
            ...
            <Button asChild variant="outline" className="mt-5 sm:mt-6 rounded-none h-11 px-6 sm:px-8 tracking-luxury text-xs border-foreground">
      ...
      <section className="mx-auto max-w-[1400px] px-4 sm:px-6 pb-12 sm:pb-20">
        <div className="text-center mb-6 sm:mb-10">
          ...
          <h2 className="font-display text-2xl sm:text-4xl">Most Loved</h2>
        </div>
      ...
      <section className="bg-[var(--beige-100)] py-12 sm:py-20">
        <div className="mx-auto max-w-xl px-4 sm:px-6 text-center">
          <h2 className="font-display text-2xl sm:text-4xl">Join the House</h2>

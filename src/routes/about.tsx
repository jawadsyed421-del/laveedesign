    ...
    <SiteLayout>
      <div className="mx-auto max-w-3xl px-6 py-20 text-center">
        ...
        <p className="mt-6 text-muted-foreground leading-relaxed">
          Monik began with a single intention — to celebrate the softest part of the Indian palette.
      ...
      <img src={veil} alt="Monik Atelier" loading="lazy" className="w-full h-[70vh] object-cover" />
